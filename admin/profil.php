...
<head>
  ...
  <title>Profil | Nusa Indah Florist Indramayu</title>
  <!--     Fonts and icons     -->
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo $username; ?>" disabled></input>
                    </div>
                    ...
                    <div class="form-group">
                        <label>No. WA:</label> 
                        <input class="form-control" value="<?php echo $no_wa; ?>" disabled></input>
                    </div>
                    <a href="update_profil.php" type="button" class="btn bg-gradient-primary">Ubah Profile</a>
                </div>
            </div>
        </div>
    </div>
