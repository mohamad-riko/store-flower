...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        // Pengalihan ke halaman manage_categories.php setelah berhasil menambahkan kategori
        header("Location: manage_categories.php");
        exit(); // Pastikan tidak ada kode berikutnya yang dieksekusi setelah pengalihan header
    } else {
...
<head>
  ...
  <title>Add Kategori | Nusa Indah Florist Indramayu</title>
  <script>
        function showNotification() {
            alert("Kategori Berhasil Ditambah successfully!");
        }
  </script>
  <!--     Fonts and icons     -->
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Katagori</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tambah Katagori</h6>
        </nav>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
             ...
             <button type="submit" class="btn bg-gradient-primary" onclick="showNotification()">Simpan</button> <a href="manage_categories.php" type="button" class="btn bg-gradient-warning">Kembali</a>  
            </form>
            <br>
            <br>
                </div>
