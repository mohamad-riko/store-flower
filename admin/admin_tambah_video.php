...
<head>
  ...
  <title>Tambah Video | Nusa Indah Florist Indramayu</title>
  <!--     Fonts and icons     -->
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Tambah Video</h6>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6 style="max-width: 200px; overflow: hidden; text-overflow: ellipsis;"><b>Upload Video Baru</b></h6>
                </div>
                <div class="card-body px-4 pt-4 pb-2">
                    <form action="proses_upload_video.php" method="post">
                        ...
                        <div class="mb-3">
                            <label for="embed_link" class="form-label">URL Video (Embed Link):</label>
                            <input type="text" id="embed_link" name="embed_link" class="form-control" required>
                            <span>awali url dengan : https://youtube.com/embed/(id youtube)</span>
                            <img src="../uploads/tutor/1.png">
                        </div>
                        <button type="submit" name="submit" class="btn btn-primary">Upload Video</button>
                    </form>
                    <br>
                    <a href="admin_video.php" class="btn btn-secondary">Kembali ke Daftar Video</a>
                </div>
            </div>
        </div>
    </div>
