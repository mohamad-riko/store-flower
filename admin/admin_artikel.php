  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <!-- End Product -->
        ...
        <li class="nav-item">
          <a class="nav-link active" href="admin_artikel.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6 style="max-width: 200px; overflow: hidden; text-overflow: ellipsis;"><b>Data Artikel</b></h6>
                    <a href="admin_artikel_tambah.php" type="button" class="btn btn-primary">Tambah Artikel Baru</a>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Batasi jumlah karakter yang ditampilkan untuk konten
        $konten = $row["konten"];
        $batasan_karakter = 100; // Atur batasan jumlah karakter yang ingin ditampilkan
        if (strlen($konten) > $batasan_karakter) {
            $konten = substr($konten, 0, $batasan_karakter) . '...';
        }
        echo "<td>" . $konten . "</td>";
        echo "<td><img src='../uploads/artikel/" . $row["foto"] . "' width='100'></td>";
        echo "<td>" . $row["tanggal_publikasi"] . "</td>";
        echo "<td>";
        echo "<a href='admin_artikel_edit.php?id=" . $row["id"] . "' class='btn btn-primary'>Edit</a>";
        echo "<button onclick='hapusArtikel(" . $row["id"] . ")' class='btn bg-gradient-danger'>Hapus Artikel</button>";
        echo "</td>";
        echo "</tr>";
            }
} else {
    echo "<tr><td colspan='5'>Tidak ada artikel.</td></tr>";
}
?>
        </tbody>
    </table>
  ...
  <script>
    function hapusArtikel(id) {
        if (confirm("Anda yakin ingin menghapus artikel ini?")) {
            // Kirim permintaan penghapusan ke halaman admin_artikel_delete.php
            window.location.href = "admin_artikel_delete.php?id=" + id;
        }
    }
</script>
