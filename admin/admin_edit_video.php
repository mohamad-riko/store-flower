...
// Periksa apakah parameter ID video telah diberikan di URL
...
// Query untuk mengambil data video dari tabel videos berdasarkan ID
...
// Pastikan video dengan ID yang diberikan ada dalam database
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kelola Dokumentasi</li>
          </ol>
...
<body>
    <div class="container">
        ...
        <form action="proses_edit_video.php" method="post">
            <input type="hidden" name="id" value="<?php echo $id_video; ?>">
            <div class="form-group">
                <label for="judul">Judul Video:</label>
                <input type="text" id="judul" name="judul" value="<?php echo $row['judul']; ?>" class="form-control">
            </div>
            <div class="form-group">
                <label for="embed">Embed Video:</label>
                <textarea id="embed" name="embed" class="form-control"><?php echo $row['embed_link']; ?></textarea>
            </div>
            <button type="submit" class="btn btn-primary">Simpan Perubahan</button>
            <a href="admin_video.php" class="btn btn-danger">Batal</a>
        </form>
    </div>
