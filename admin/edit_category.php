...
// Query untuk mendapatkan detail kategori berdasarkan ID
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($update_query) === TRUE) {
        // Jika update berhasil, arahkan kembali ke halaman manage_categories.php
...
<head>
  ...
  <title>Edit Kategori | Nusa Indah Florist Indramayu</title>
  <script>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <form method="post" action="">
                    ...
                    <label for="name">Nama Kategori Baru:</label><br>
                    <input type="text" id="name" name="name" value="<?php echo $row['name']; ?>" class="form-control" required><br>

             <button type="submit" class="btn bg-gradient-primary" onclick="showNotification()">Update</button> <a href="manage_categories.php" type="button" class="btn bg-gradient-warning">Kembali</a>  
            </form>
