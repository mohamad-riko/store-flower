...
<head>
  ...
  <title>Dashboard | Nusa Indah Florist Indramayu</title>
  <!--     Fonts and icons     -->
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h6 class="font-weight-bolder mb-0">
                      <a href="admin_products.php">Semua Product</a>
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <a href="admin_products.php"><i class="ni ni-cart text-lg opacity-10" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h6 class="font-weight-bolder mb-0">
                      <a href="manage_categories.php">Kategori Produk</a>
                      <span class="text-success text-sm font-weight-bolder"></span>
                    </h6>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <a href="manage_categories.php"><i class="ni ni-collection opacity-10" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <a href="admin_video.php"><i class="ni ni-camera-compact text-lg opacity-10" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <a href="admin_gallery.php"><i class="ni ni-album-2 text-lg opacity-10" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold"></p>
                    <h6 class="font-weight-bolder mb-0">
                      <a href="admin_gallery.php">Profil </a>
                      <span class="text-success text-sm font-weight-bolder"></span>
                    </h6>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <a href="profil.php"><i class="ni ni-album-2 text-lg opacity-10" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <center>
            <img src="../admin/assets/img/logo.png" style="width: 390px">
        </center>
    </div>
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Nusa Indah Florist Indramayu</h5>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="d-flex">
          ...
          <button class="btn bg-gradient-primary w-100 px-3 mb-2 ms-2" data-class="bg-white" onclick="sidebarType(this)">White</button>
                 <a href="../logout.php" class="btn bg-gradient-danger w-100 px-3 mb-2 ms-2" data-class="bg-white">Logout</a>
        </div>
