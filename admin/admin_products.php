...
// Query untuk mendapatkan daftar produk beserta kategorinya dengan batasan jumlah data per halaman
...
<head>
  ...
  <title>
  Produk | Nusa Indah Florist Indramayu
  </title>
  <!--     Fonts and icons     -->
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <a href="admin_product_tambah.php" type="button" class="btn btn-primary">Tambah Product Baru</a>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                <?php 
                                // Menampilkan 4 data per halaman
                                $limit = 4;
                                $page = isset($_GET['page']) ? $_GET['page'] : 1;
                                $start = ($page - 1) * $limit;
                                $count = $start + 1; // Nomor urut pertama pada halaman ini
                                ...
                                while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                       ...
                                       <td><center><?php echo $count++; ?></center></td>
                                        ...
                                        <td><img src="<?php echo $row['foto']; ?>" alt="Foto Produk" style="width: 100px"></td>
                                        <td>
                                            <a href="admin_product_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                            <form action="admin_product_delete.php" method="post" style="display: inline-block;">
