...
// Query untuk mendapatkan semua item dari galeri
...
<head>
  ...
  <title>Galeri | Nusa Indah Florist Indramayu</title>
  <!--     Fonts and icons     -->
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <a href="admin_tambah_gallery.php" type="button" class="btn btn-primary">Tambah Galeri Baru</a>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td style="font-weight: bold;"><?php echo $row['judul']; ?></td>
                                    <td>
                                        <a href="<?php echo $row['foto']; ?>" target="_blank">
                                            <img src="<?php echo $row['foto']; ?>" style="width: 100px;" alt="<?php echo $row['judul']; ?>">
                                        </a>
                                    </td>
                                    <td style="font-size: 12px;"><?php echo $row['deskripsi']; ?></td>
                                    <td>
                                        <a href="admin_gallery_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                        <form action="admin_gallery_delete.php" method="post" style="display: inline-block; margin-left: 5px;">
