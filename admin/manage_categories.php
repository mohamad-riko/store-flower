...
<head>
  ...
  <title>Kategori | Nusa Indah Florist Indramayu</title>
  <!--     Fonts and icons     -->
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6 style="max-width: 200px; overflow: hidden; text-overflow: ellipsis;"><b>Manajemen Kategori</b></h6>
                    <a href="admin_add_category.php" type="button" class="btn btn-primary">Tambah Kategori Baru</a>
                                    ...
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr style="text-align: center;">
                                          ...
                                          <td>
                                            ...
                                            <form action="delete_category.php?id=<?php echo $row['id']; ?>" method="post" style="display: inline-block;">
