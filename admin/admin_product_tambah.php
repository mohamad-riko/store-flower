...
<head>
  ...
  <title>
    Tambah Produk | Nusa Indah Florist Indramayu
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-start p-3 w-100">  <span style="color: black"><center>2024</center>
          </div>
        </div>
      </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Periksa apakah discount_price diatur
    $discount_price = ($_POST["discount_price"] !== '') ? $_POST["discount_price"] : null; // Discount price
    ...
    if ($foto_error === UPLOAD_ERR_OK) {
        ...
        $upload_dir = "../../uploads/product"; // Update lokasi penyimpanan foto
        $foto_path = $upload_dir . basename($foto_name);

        // Membuat direktori jika belum ada
        if (!file_exists($upload_dir)) {
            mkdir($upload_dir, 0777, true); // Buat direktori rekursif dengan izin baca, tulis, dan jalankan untuk semua
        }

        // Pindahkan foto ke lokasi penyimpanan
        if (move_uploaded_file($foto_tmp, $foto_path)) {
            // Konversi harga ke format yang sesuai untuk disimpan di database
            $price_decimal = str_replace(',', '.', $price);

            // Eksekusi penambahan produk ke database
            $sql = "INSERT INTO products (name, category_id, price, deskripsi, foto, discount_price) VALUES ('$name', '$category_id', '$price_decimal', '$deskripsi', '$foto_path', '$discount_price')";
...
<form method="post" action="" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <label for="discount_price">Harga Diskon:</label><br> <!-- Tambahkan input untuk harga diskon -->
        <input type="text" id="discount_price" name="discount_price" step="0.01"><br><br>
        ...
        <br><br>
        <a href="admin_products.php" class="btn btn-primary">Kembali</a>
        <a href="admin_add_category.php" class="btn btn-info">Tambah Kategori</a>
    </div>
</form>
