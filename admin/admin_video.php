...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query untuk mencari video berdasarkan judul
    $query = "SELECT * FROM videos WHERE judul LIKE '%$search%'";
} else {
    // Jika form tidak disubmit, tampilkan semua video
...
// Cek jika terjadi error saat menjalankan query
if (!$result) {
...
<head>
  ...
  <title>Video | Nusa Indah Florist Indramayu</title>
  <!--     Fonts and icons     -->
   ...
   <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <!-- End Product -->
        ...
        <li class="nav-item">
          <a class="nav-link active " href="admin_video.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<!--  -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <a href="admin_tambah_video.php" class="btn btn-primary mb-3">Tambah Video Baru</a>
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="mb-3">
                            <div class="form-group">
                                <label for="search">Cari Video:</label>
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>";
                // Menampilkan video YouTube yang disematkan menggunakan tag <iframe>
                echo "<iframe width='560' height='315' src='" . $row["embed_link"] . "' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
                echo "</td>";
                echo "<td>";
                echo "<a href='admin_edit_video.php?id=" . $row["id"] . "' class='btn btn-sm btn-primary'>Edit</a> ";
                echo "<a href='admin_hapus_video.php?id=" . $row["id"] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus video ini?\")'>Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
            ?>
