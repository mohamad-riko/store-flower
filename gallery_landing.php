...
<!--  -->
  ...
  <!-- Single Page Header start -->
        <div class="container-fluid page-header-01 py-5" style="background-image: url(landing-page/template-2-card/img/produk/berduka.png);" >
<!--             <h1 class="text-center text-white display-6">Product Happy Wedding</h1>
 -->           
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="gallery_landing.php" class="nav-item nav-link active" style="color: blue;">Galeri</a>
  ...
  <div class="breadcrumbs" style="background-image: url('landing-page/template-2-card/img/produk/gallery.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #C2B3A7">
  <div class="container">
    <div class="row">
      <div class="col-12">
   ...
   <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                <h1 class="display-4">Dokumentasi Gambar</h1>
                <p>Dekripsi</p>
            </div>
            <!-- Isi gambar -->
            <div class="row">
                ...
                // Query untuk mengambil data gambar dari tabel gallery
                ...
                if ($gallery_result->num_rows > 0) {
                    ...
                    while ($gallery_row = $gallery_result->fetch_assoc()) {
                        // Periksa apakah kunci array tersedia sebelum mengaksesnya
                        if (isset($gallery_row['foto']) && isset($gallery_row['deskripsi'])) {
                            // Tampilkan gambar
                            echo '<div class="col-md-4 mb-4">';
                            echo '<div class="card">';
                            echo '<img src="gallery/' . $gallery_row['foto'] . '" class="card-img-top" alt="' . $gallery_row['deskripsi'] . '">';
                            echo '<div class="card-body">';
                            echo '<p class="card-text">' . $gallery_row['deskripsi'] . '</p>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        } else {
                            ...
                            echo '<div class="card">';
                            echo '<div class="card-body">';
                            echo '<p class="card-text">Data gambar tidak lengkap</p>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        }
                    ...
                    // Tampilkan pesan jika tidak ada gambar yang tersedia
                    echo "<p>Tidak ada gambar yang tersedia saat ini.</p>";
                }
...
<!-- Conten Video -->
<!-- Bagian konten utama (landing page) -->
<div class="container-fluid">
    <div class="container py-5">
        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
            <h1 class="display-4">Dokumentasi Video</h1>
            <p>Dekripsi</p>
        </div>
        <!-- Isi video -->
        <div class="row">
            ...
            // Query untuk mengambil data video dari tabel videos
            $video_query = "SELECT * FROM videos";
            $video_result = $conn->query($video_query);

            // Periksa apakah ada video yang tersedia
            if ($video_result->num_rows > 0) {
                // Loop melalui setiap baris hasil query
                while ($video_row = $video_result->fetch_assoc()) {
                    // Periksa apakah kunci array tersedia sebelum mengaksesnya
                    if (isset($video_row['embed_link']) && isset($video_row['judul'])) {
                        // Tampilkan video embed
                        echo '<div class="col-md-6 mx-auto">';
                        echo '<div class="card mb-4">';
                        echo '<div class="card-body">';
                        echo '<h5 class="card-title">' . $video_row['judul'] . '</h5>';
                        echo '<div class="embed-responsive embed-responsive-16by9">';
                        echo '<iframe class="embed-responsive-item" src="' . $video_row['embed_link'] . '" allowfullscreen></iframe>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        ...
                        echo '<div class="col-md-6 mx-auto">';
                        echo '<p>Data video tidak lengkap</p>';
                        echo '</div>';
                    }
                }
            } else {
                // Tampilkan pesan jika tidak ada video yang tersedia
                echo "<p>Belum ada video yang tersedia saat ini.</p>";
            }
