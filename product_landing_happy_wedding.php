...
<head>
  ...
  <!-- Title Tag  -->
  <title>Produk Happy Wedding | Nusa Indah Florist Indramayu</title>
  <!-- Site Metas -->
...
<body >
  ...
  <!-- Single Page Header start -->
        <div class="container-fluid page-header-01 py-5" style="background-image: url(landing-page/template-2-card/img/produk/wedding.png);" >
<!--             <h1 class="text-center text-white display-6">Product Happy Wedding</h1>
 -->           
        </div>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="product_landing.php" class="nav-item nav-link">Produk</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link active dropdown-toggle" style="color: blue;" data-bs-toggle="dropdown">Kategori Produk</a>
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="product_landing_happy_wedding.php" class="dropdown-item active">Happy Wedding</a>
...
<!-- Conten Gallery -->
  <div class="breadcrumbs" style="background-image: url('landing-page/template-2-card/img/produk/wedding.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #C2B3A7">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
// Query untuk mendapatkan kategori "Hand Bouquet"
$category_query = "SELECT * FROM categories WHERE name = 'HAPPY WEDING'";
$category_result = $conn->query($category_query);

// Periksa apakah kategori "Hand Bouquet" ditemukan
if ($category_result->num_rows > 0) {
    // Fetch data kategori "Hand Bouquet"
    $category_row = $category_result->fetch_assoc();
    $category_id = $category_row['id'];

    // Query untuk mendapatkan produk berdasarkan kategori "Hand Bouquet"
    $product_query = "SELECT * FROM products WHERE category_id = $category_id";
    $product_result = $conn->query($product_query);

    // Periksa apakah ada produk yang tersedia untuk kategori ini
    if ($product_result->num_rows > 0) {
        ?>
        <section class="product_section">
            <div class="container">
                <div class="product_heading">
                    <h2>PRODUCT <?php echo $category_row['name']; ?></h2>
                </div>
                <div class="product_container">
                    <?php
                    // Loop melalui setiap produk untuk kategori ini
                    while ($product_row = $product_result->fetch_assoc()) {
                        ?>
                        <div class="box">
                            <div class="box-content">
                                <div class="img-box">
                                    <img src="<?php echo $product_row['foto']; ?>" alt="<?php echo $product_row['name']; ?>" style="object-fit: cover;">
                                </div>
                                <div class="detail-box">
                                    <div class="text">
                                        <h6><?php echo $product_row['name']; ?></h6>
                                        <h5><span>Rp. </span><?php echo $product_row['price']; ?></h5>
                                    </div>
                                    <div class="like">
                                        <h6>
                                            <?php
                            ...
                            <div class="btn-box">
                        <a href="detail_product.php?id=<?php echo $product_row['id']; ?>" class="btn btn-outline-success">Order Sekarang</a> |
                        <a href="product_landing_detail.php?id=<?php echo $product_row['id']; ?>" class="btn btn-outline-warning" >Detail Product</a> 
                    </div>
                        </div>
                    <?php
                    }
...
<?php
        ...
        // Tampilkan pesan jika tidak ada produk yang tersedia untuk kategori ini
        echo "<p>No products available for this category.</p>";
    }
} else {
    // Tampilkan pesan jika kategori "Hand Bouquet" tidak ditemukan
    echo "<p>Category 'Hand Bouquet' not found.</p>";
}
?>
          ...
          <div class="col-lg-3 col-md-6 col-12">
            ...
            <div class="single-footer social">
              ...
              <ul>
                ...
                <li><a href="nusaindahfloristindramayu.com" target="_blank" ><i class="fab fa-firefox-browser	"></i></a></li>
