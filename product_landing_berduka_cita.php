...
<head>
  ...
  <!-- Title Tag  -->
  <title>Produk Berduka Cita | Nusa Indah Florist Indramayu</title>
  <!-- Site Metas -->
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="product_landing_berduka_cita.php" class="dropdown-item active">Berduka Cita</a>
...
<!-- Conten Gallery -->
<div class="breadcrumbs" style="background-image: url('landing-page/template-2-card/img/produk/berduka.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #C2B3A7">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
$category_query = "SELECT * FROM categories WHERE name = 'TURUT BERDUKA CITA'";
