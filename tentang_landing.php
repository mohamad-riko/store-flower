...
<head>
  ...
  <!-- Title Tag  -->
  <title>Tentang | Nusa Indah Florist Indramayu</title>
  <!-- Site Metas -->
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="tentang_landing.php" class="nav-item nav-link active" style="color: blue;">Tentang</a>
...
<section>
  <div class="breadcrumbs-tentang" style="background-image: url('landing-page/template-2-card/img/produk/tentang.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #C2B3A7">
  <div class="container">
    <div class="row">
      <div class="col-12">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
           <img src="landing-page/template-2-card/img/logo.png" style="width: cover;">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p style="text-align: justify;">
             Nusa Indah Florist merupakan toko bunga yang melayani berbagai karangan bunga seperti pembuatan Taman, Dekorasi Acara, Custom pemuatan Hand Bouqet, Bunga Papan seperti (Happy Wedding, Turut Berduka Cita, Selamat Sukses) dan lain-lain.<br><br>

              Toko Kami melayani jangkauan layanan yang cukup besar dan tersebar di ciayumajakuning dan khususnya seluruh wilayah indramayu. Dengan adanya layanan kami yang cukup luas tentu saja untuk berkomitmen untuk meningkatkan layanan kami kepada pelanggan dimana menjungjung tinggi layanan dan kepuasan pelanggan itu sendiri.
            </p>
            <a href="product_landing.php" class="btn-learn-more">Lihat Semua Produk Kami</a>
          </div>
        </div>

      </div>
    </section>
    <br><!-- End About Us Section -->
<!-- ======= Why Us Section ======= -->
<section>
    <footer class="footer">
    <!-- Footer Top -->
