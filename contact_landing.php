...
<head>
  ...
  <!-- Title Tag  -->
  <title>Contact | Nusa Indah Florist Indramayu</title>
  <!-- Site Metas -->
...
<!--             <h1 class="text-center text-white display-6">Product Happy Wedding</h1>
 -->           
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="contact_landing.php" class="nav-item nav-link active" style="color: blue;">Contact</a>
                        </div>
  ...
  <div class="breadcrumbs" style="background-image: url('landing-page/template-2-card/img/produk/kontak.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #C2B3A7">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          <ul class="bread-list">
            <li><a href="index.php"><i class="ti-arrow-right"></i></a></li>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                <h1 class="text-primary">Alamat detail</h1>
                                <p class="mb-4"><b>Jl Islamic Center Indramayu, Belakang TIC Karaoke Bungkul, Bojongsari-Indramayu, <br>Jawa Barat (Patokan dan Arah Masuk Lokasi)</b><br>
                                  <a href="#"><br><img src="landing-page/template-2-card/img/patokan.png" style="width: 900px"></a></p>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="h-100 rounded">
                                <center><b>Atau bisa Klik Maps Dibawah ini:</center>
                                <iframe class="rounded w-100" 
                                style="height: 600px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3965.3536896999685!2d108.320242613554!3d-6.348228751779252!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6eb94713b6285b%3A0xc2086701e97adb5a!2sM82C%2BP3X%2C%20Kec.%20Indramayu%2C%20Kabupaten%20Indramayu%2C%20Jawa%20Barat%2045214!5e0!3m2!1sid!2sid!4v1707559959296!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
